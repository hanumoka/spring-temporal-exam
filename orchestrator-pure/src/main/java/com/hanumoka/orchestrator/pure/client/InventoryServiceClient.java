...
public class InventoryServiceClient {
    ...
    public void reserveStock(Long productId, int quantity) {
        log.debug("[Resilience4j] 재고 예약 시도: productId={}, quantity={}", productId, quantity);
    ...
    public void cancelReservation(Long productId, int quantity) {
        log.debug("[Resilience4j] 재고 예약 취소 시도: productId={}, quantity={}", productId, quantity);
    ...
    private void cancelReservationFallback(Long productId, int quantity, Exception ex) {
